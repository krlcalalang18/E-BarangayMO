...
<head>
    ...
    <link rel="stylesheet" href="citizen_reg.css">
    <style>
        .container {
            margin-top: 50px;
        }
...
<body>
    ...
    <div class="text-center">
            <img src="Logo.png" class="img-fluid col-md-3" alt="logo">
        </div>
        ...
        <form action="registration.php" method="POST" enctype="multipart/form-data">
            ...
            <a class="btn btn-success" href="citizen_login_page.html"> Back to Login </a>
        </form>
