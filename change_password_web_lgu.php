...
<head>
    ...
    <link rel="stylesheet" href="changepassweblgu.css">
    <style>
        .container {
            margin-top: 100px;
            max-width: 400px;
...
<br>
     <div class="button2">   
        <a href="lgu_operator_login_page.php"><button type="submit"class="btn btn-info">Back to Login</button></a>
        <a href="change_password_web_sms_lgu.php"><button type="submit"class="btn btn-danger">Verify through SMS</button></a>
     </div>
    </div>
</body>
</html>
