...
$sql = "SELECT cityName, cityID FROM city";
...
$sql = "SELECT bs.barangayID, bs.barangayName, bs.barangayHallAddress, c.cityName, c.cityID
        ...
        ORDER BY barangayName ASC, cityName";
$result = $conn->query($sql);
        ...
        Edit
            ...
            <div class='modal-dialog' role='document'>
                <div class='modal-content'>
                    ...
                    <label for='cityName'>Barangay Name</label>
                    <input type='text' class='form-control' value='$barangayName' name='barangayName'>
                    </div>

                    <div class='form-group'>
                    <label for='cityName'>Barangay Hall Address</label>
