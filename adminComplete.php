...
WHERE c.complaintStatus = 'Complete'";
...
if (!empty($search)) {
                                ...
                                <div class='modal-dialog' role='document'>
                                    <div class='modal-content'>
                                        ...
                                        <input type='text' class='form-control' rows='3' value='$complaintType' readonly>
                                            ...
                                            <form method='POST' action='adminComplete.php' enctype='multipart/form-data'>
    ...
    <nav aria-label="Page navigation">
        <ul class="pagination justify-content-center">
            ...
            // Previous page
            if ($page > 1) {
                echo "<li class='page-item'><a class='page-link' href='adminComplete.php?page=" . ($page - 1) . "&show=$perPage&search=$search'>Previous</a></li>";
            }

            // Page numbers
            for ($i = 1; $i <= $totalPages; $i++) {
                echo "<li class='page-item " . ($i == $page ? 'active' : '') . "'><a class='page-link' href='adminComplete.php?page=$i&show=$perPage&search=$search'>$i</a></li>";
            }

            // Next page
            if ($page < $totalPages) {
                echo "<li class='page-item'><a class='page-link' href='adminComplete.php?page=" . ($page + 1) . "&show=$perPage&search=$search'>Next</a></li>";
            }
            ?>
        </ul>
    </nav>
