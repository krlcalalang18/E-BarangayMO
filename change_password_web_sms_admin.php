...
<form method="POST">
    ...
    <button type="submit" name="generateOTP" >Send OTP</button>
        ...
        <br>
        <a href="adminBlockerPage.html"><button type="submit"class="btn btn-info">Back to Login</button></a>
        <br>
        <br>
        <a href="change_password_web.php"><button type="submit"class="btn btn-danger">Verify through Email</button></a>
    </div>
