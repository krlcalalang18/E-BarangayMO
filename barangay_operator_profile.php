        ...
        <h2>Operator Profile</h2>
            ...
            ?>
                ...
                $sql = "SELECT bo.brgyOperatorID, u.userID, u.firstName, u.lastName, u.middleName, u.emailAddress, u.streetAddress, u.city, u.barangay, u.cellphoneNumber, u.password, u.accountType, u.accountStatus,
                        ...
                        WHERE brgyOperatorID = '$testSession'"; //THIS CODE SHOULD BE FROM THE SESSION
                $result = $conn->query($sql);
                ...
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        ...
                        <button type='button' class='btn btn-danger' data-toggle='modal' data-target='#PmyModal$brgyOperatorID'>
                                        Change Password
                        </button>
                        ...
                        <button type='submit' name='updateMe' class='btn btn-primary'>Update</button>
                            ...
                            echo "<div class='modal fade' id='PmyModal$brgyOperatorID' tabindex='-1' role='dialog' aria-labelledby='myModalLabel' aria-hidden='true'>
                                <div class='modal-dialog' role='document'>
                                    <div class='modal-content'>
                                        <div class='modal-header'>
                                            <h5 class='modal-title' id='myModalLabel'>Complaint Details</h5>
