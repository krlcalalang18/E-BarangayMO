...
<head>
    ...
    <link rel="stylesheet" href="changepasscitizen.css">
    <style>
        .container {
            margin-top: 100px;
            max-width: 400px;
...
<br>
        ...
        <a href="change_password_sms.php"><button type="submit"class="btn btn-danger">Verify Through SMS</button></a>
        </div>
    </div>
