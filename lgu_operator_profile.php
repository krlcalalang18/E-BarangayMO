...
<body>
    <div class="container">
        ...
        <div class="profile">
            ...
            <div class="tabs">
                <a href="lgu_operator_profile.php"><div class="tab active">Profile</div></a>
        ...
        <h2>Operator Profile</h2>
            ...
            <?php
                ...
                if (isset($_POST['updateMe'])) {
                        $LguOperatorID = $_POST["LguOperatorID"];
                    ...
                    $sql = "UPDATE user u
                            ...
                            SET u.firstName = '$firstName', 
                                ...
                                u.password = '$password'
                            WHERE u.userID = '$testSession'"; //ADD SESSION CODE HERE
            ...
            ?>
                ...
                $sql = "SELECT lo.LguOperatorID, u.userID, u.firstName, u.lastName, u.middleName, u.emailAddress, u.streetAddress, u.city, u.barangay, u.cellphoneNumber, u.password, u.accountType, u.accountStatus, c.cityName
                        FROM user u
                        INNER JOIN lgu_operator lo ON u.userID = lo.userID
                        INNER JOIN city c ON lo.cityID = c.cityID
                        WHERE LguOperatorID = '3'"; //THIS CODE SHOULD BE FROM THE SESSION
                $result = $conn->query($sql);

                
                if ($result->num_rows > 0) {
                    while ($row = $result->fetch_assoc()) {
                        $LguOperatorID = $row["LguOperatorID"];
                        $userID = $row["userID"];
                        ...
                        <button type='button' class='btn btn-primary' data-toggle='modal' data-target='#myModal$LguOperatorID'>
                                        Edit Profile
                        </button>

                        <br> <br>

                        <button type='button' class='btn btn-danger' data-toggle='modal' data-target='#PmyModal$LguOperatorID'>
                                        Change Password
                        </button>
                        ...
                        //POP UP MODAL
                        echo "<div class='modal fade' id='myModal$LguOperatorID' tabindex='-1' role='dialog' aria-labelledby='myModalLabel' aria-hidden='true'>
                                <div class='modal-dialog' role='document'>
                                    <div class='modal-content'>
                                        ...
                                        <input type='hidden' name='LguOperatorID' value='$LguOperatorID'>
                        ...
                        <div class='form-group'>
                        <label for='LastName'>Password</label>
                        <input type='password' class='form-control' value='$password' name='password' readonly>
                        </div>     
                        ...
                        <button type='submit' name='updateMe' class='btn btn-primary'>Update</button>
                            ...
                            echo "<div class='modal fade' id='PmyModal$LguOperatorID' tabindex='-1' role='dialog' aria-labelledby='myModalLabel' aria-hidden='true'>
                                <div class='modal-dialog' role='document'>
                                    <div class='modal-content'>
                                        <div class='modal-header'>
                                            <h5 class='modal-title' id='myModalLabel'>Complaint Details</h5>
                                        ...
                                        <form method='POST' action=''>
                                        <input type='hidden' name='brgyOperatorID' value='$LguOperatorID'>

                        <div class='form-group'>
                        <label for='LastName'>Password</label>
                        <input type='password' class='form-control' placeholder='Input New Password' name='password'>
                        </div>     
